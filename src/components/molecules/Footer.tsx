            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div className="flex items-center justify-center space-x-6 mt-4 md:mt-0">
                        <Link href="https://www.instagram.com/fad_find_a_date?igsh=aHh1MTMyZzY4aWQ1"  target="_blank" rel="noreferrer" className="text-pink-700 hover:text-accent-foreground">
                            <svg
